        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-2 space-y-8 animate-fadeIn">
              {/* Project Image or Interactive Demo */}
              {project.interactive && project.demoUrl ? (
                <div className="relative h-[750px] rounded-lg overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800">
                  <iframe
                    src={project.demoUrl}
